...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      nav_plans: "Plans",
      nav_teachers: "Our Teachers",
      nav_apply: "Apply Now",
      nav_login: "Login",
      nav_register: "Register",
      hero_title: "Learn English at Home!",
      hero_lead:
        "Calm, engaging English lessons for children ages 3–6. Live classes designed for busy Filipino families.",
      hero_account_note:
    ...
    zh: {
      ...
      nav_register: "注册",
      hero_title: "在家学英语！",
      hero_lead: "适合 3–6 岁儿童的沉浸式英语直播课，专为忙碌的菲律宾家庭设计。",
    ...
    ja: {
      ...
      hero_lead: "3〜6歳のお子さま向けのライブ英語レッスン。忙しいご家庭のために設計されています。",
    ...
    ko: {
      ...
      hero_lead: "3–6세 어린이를 위한 라이브 영어 수업. 바쁜 필리핀 가정을 위해 설계되었습니다.",
