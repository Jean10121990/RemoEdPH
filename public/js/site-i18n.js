...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      error_invalid: "Invalid Student ID or password.",
      suspended_generic:
    ...
    zh: {
      ...
      student_id_label: "学生账号",
      student_id_placeholder: "请输入学生账号",
      password_label: "密码",
    ...
    ja: {
      ...
      student_id_label: "学生ID",
      student_id_placeholder: "学生IDを入力",
      ...
      error_invalid: "学生IDまたはパスワードが正しくありません。",
      suspended_generic:
    ...
    ko: {
      ...
      student_id_placeholder: "학생 ID 입력",
      password_label: "비밀번호",
      ...
      error_invalid: "학생 ID 또는 비밀번호가 올바르지 않습니다.",
      suspended_generic:
