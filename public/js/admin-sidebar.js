...
(function (global) {
    ...
    var MENU_ITEMS = [
        ...
        { id: 'marketing', label: 'Marketing', href: 'admin-marketing-hub.html', icon: '<svg fill="none" stroke="currentColor" ' + SVG_STROKE + ' viewBox="0 0 24 24"><path d="M3 11l19-9-9 19-2-8-8-2z"/></svg>' },
    ...
    function shouldShowNavItem(itemId) {
        ...
        if (itemId === 'marketing') return role === 'admin_accounting';
        return true;
    }
    ...
    function queuePortalLayoutMount() {
        ...
        s.src = 'js/portal-layout.js?v=app-shell-11';
        s.async = true;
