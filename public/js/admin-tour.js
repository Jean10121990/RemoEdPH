...
(function () {
  ...
  function buildSteps() {
    return [
      ...
      },
      {
        ...
        content:
          'Payroll and Student Subscriptions — use tabs for pay and every student plan. Unique link commissions moved to Marketing Hub.',
        position: 'right',
      },
      {
  ...
  function init() {
    ...
    var welcome =
      ...
      'This tour maps each sidebar section — HR Hub, QA Hub, Accounting Hub, Marketing Hub, reports, and more — so you can navigate with confidence.\n\n' +
